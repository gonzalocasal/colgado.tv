...
'player'=>'<iframe style="border:none!important;height:30px;width:280px;margin:0 40px" src="http://www.alsolnet.com/stream/amdelplata/" allowtransparency="true" class="style-scope my-player"></iframe>'];
