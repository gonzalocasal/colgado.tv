...
'player'=>'<iframe style="border:none!important;height:30px;width:280px;margin:0 40px" src="http://latinstatic.edgesuite.net/delplata/" allowtransparency="true" class="style-scope my-player"></iframe>'];
